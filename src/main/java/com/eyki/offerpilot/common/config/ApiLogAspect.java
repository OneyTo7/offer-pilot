...
public class ApiLogAspect {
    ...
    public Object logApiCall(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        log.info("[API 请求] traceId={}, {}{} {}.{}(), args={}",
                traceId, method, uri, className, methodName, truncateArgs(args));

        try {
            Object result = joinPoint.proceed();
            Duration elapsed = Duration.between(start, Instant.now());
            log.info("[API 响应] traceId={}, {}{} 耗时={}ms",
                    traceId, method, uri, elapsed.toMillis());
            return result;
        } catch (Exception e) {
            Duration elapsed = Duration.between(start, Instant.now());
            log.error("[API 异常] traceId={}, {}{} 耗时={}ms, error={}",
                    traceId, method, uri, elapsed.toMillis(), e.getMessage());
            throw e;
        }
    }
