...
/**
 * Advisor that adds a "re-reading" instruction to the system prompt.
 * Improves reasoning quality by asking the model to read the question twice before answering.
 */
    ...
    private ChatClientRequest appendSystemInstruction(ChatClientRequest request) {
        ...
        return ChatClientRequest.builder()
                .prompt(new org.springframework.ai.chat.prompt.Prompt(
                        currentContent + RE_READING_INSTRUCTION))
                .build();
    }
}